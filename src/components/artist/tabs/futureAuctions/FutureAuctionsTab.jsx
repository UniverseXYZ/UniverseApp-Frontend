...
const FutureAuctionsTab = () => {
    ...
    const artistFutureAuctions = PLACEHOLDER_FUTURE_AUCTIONS.filter(auction => auction.artist.id === location.state.id);
    ...
    ) : <div className='empty__nfts'><h3>No future auctions found</h3></div>
}
