...
const MintNft = ({ onClick }) => {
  ...
  return (
    <div className="mintNft-div">
      <h2>Create NFT</h2>
      <p>
        Choose “Single NFT” if you want your NFT to be one of a kind or “NFT Collection” if you want
        to create an ERC-721 with ERC-721 tokens inside
      </p>
      <div className="ntfs">
        <div
          className="nft-box"
        ...
        >
          ...
          <div className="nft-box-highlight-one" />
          <div className="nft-box-highlight-two" />
        </div>
      </div>
    </div>
  );
