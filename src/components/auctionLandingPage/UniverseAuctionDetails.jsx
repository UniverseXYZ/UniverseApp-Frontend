        ...
        <AnimatedOnScroll animationIn="fadeInUp" animationInDelay={200}>
          <div className="box">
            ...
            <p className="sub__desc">
              ...
              minutes left on the auction. This gives everyone ample time to place a bid and have a
              fair chance at the auction.
            </p>
          </div>
        </AnimatedOnScroll>
        <AnimatedOnScroll animationIn="fadeInUp" animationInDelay={400}>
          <div className="box">
            ...
            <p className="sub__desc">
              ...
              you will be able to Bid with any currency in your wallet which means no more wasting
              gas on failed swaps to get a bid placed in time.
            </p>
          </div>
        </AnimatedOnScroll>
        ...
        <AnimatedOnScroll animationIn="fadeInUp" animationInDelay={800}>
          <div className="box">
            ...
            <p className="sub__desc">
              ...
              strategically set up so that a specific slot has specific NFTs, usually the best tier
              will be slot 1 which has the best NFTs and lowest edition numbers.
            </p>
          </div>
        </AnimatedOnScroll>
      </div>
