  ...
  return (
    <div className="browse--nft--list">
      {nfts
        ...
        // .sort((a, b) => new Date(b.listedDate) - new Date(a.listedDate))   recently listed
        // .sort((a, b) => new Date(b.startDate) - new Date(a.startDate))    recently created
        // .filter((item) => item.soldDate !== '-')
        // .sort((a, b) => new Date(b.soldDate) - new Date(a.soldDate))   recently sold
        // .sort((a, b) => b.likesCount - a.likesCount)   most liked
        .map(
          (nft, index) =>
            index <= nftNumber && (
      ...
      {/* <Button onClick={() => setSortName('Ending soon')}>Ending soon</Button>
      <Button onClick={() => setSortName('Lowest price first')}>Lowest price first</Button>
      <Button onClick={() => setSortName('Highest price first')}>Highest price first</Button>
      <Button onClick={() => setSortName('Recently listed')}>Recently listed</Button>
      <Button onClick={() => setSortName('Recently created')}>Recently created</Button>
      <Button onClick={() => setSortName('Recently sold')}>Recently sold</Button>
      <Button onClick={() => setSortName('Most liked')}>Most liked</Button> */}
    </div>
  );
};
NFTsList.propTypes = {
