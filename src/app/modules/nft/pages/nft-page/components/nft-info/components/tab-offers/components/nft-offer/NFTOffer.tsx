...
export const  NFTOffer: React.FC<INFTOfferProps> = ({offer, usersMap, order, owner, setOfferForAccept, cancelOffer}) => {
  ...
  const canAcceptsOffers = order.maker !== address && owner?.toLowerCase() === address && !isExpired;
