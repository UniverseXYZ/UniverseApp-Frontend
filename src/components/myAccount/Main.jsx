...
const Main = () => {
    ...
    const [accountPage, setAccountPage] = useState("universe.xyz/"+loggedInArtist.universePageAddress)
                ...
                {nameEditing?
                    ...
                    <div className="account-grid-name1">
                        ...
                        <div className="account-grid-name-editing">    
                            ...
                            <Input placeholder="Enter your universe page address" className="inp" value={accountPage} onChange={(e) => e.target.value.startsWith('universe.xyz/') && setAccountPage(e.target.value)}/>
                            {
