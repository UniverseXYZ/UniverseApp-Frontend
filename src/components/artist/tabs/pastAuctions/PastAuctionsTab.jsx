...
const PastAuctionsTab = () => {
    ...
    const artistPastAuctions = PLACEHOLDER_PAST_AUCTIONS.filter(auction => auction.artist.id === location.state.id);
    ...
    ) : <div className='empty__nfts'><h3>No past auctions found</h3></div>
}
