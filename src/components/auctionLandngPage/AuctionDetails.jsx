                ...
                {getAllAuctionsForCurrentArtist.length && getAllAuctionsForCurrentArtist.length > 1 ?
                    <Slider {...sliderSettings}>
                        {getAllAuctionsForCurrentArtist.map(act => {
                            return (
                                <div key={act.id} className={`carousel__auction__container ${selectedAuction.id === act.id ? 'selected' : ''}`} onClick={() => { setSelectedAuction(act); setLoading(true) }}>
                            ...
                            <div className='auction__details__box__top__bidders'>
                                <div className='auction__details__box__top__bidders__header'>
                                    ...
                                    >
                                        {
                                            (close) => (
                                                <BidRankingsPopup onClose={close} onBidders={selectedAuction.bidders}  />
                                            )
                                        }
                                    </Popup>
                                </div>
                                ...
                                <div className='auction__details__box__top__bidders__footer'>
                                    ...
                                    <div className='place__bid'>
                                        ...
                                        >
                                            {
                                                (close) => (
                                                    <PlaceBidPopup onClose={close} onAuctionTitle={selectedAuction.title} onArtistName={selectedAuction.artist.name} />
                                                )
                                            }
                                        </Popup>
                                    </div>
