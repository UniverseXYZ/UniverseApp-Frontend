                    ...
                    {loggedInArtist.id !== onArtist.id ? 
                        ...
                        <div className='artist__details__section__container'>
                            ...
                            <div className='info'>
                                ...
                                <div className='social__links'>
                                    <a href={'https://www.instagram.com/'+loggedInArtist.instagramLink} target='_blank' title={'https://www.instagram.com/'+loggedInArtist.instagramLink}>
                                        <img src={instagramIcon} alt='Instagram' />
                                    </a>
                                    <a href={'https://twitter.com/'+loggedInArtist.twitterLink} target='_blank' title={'https://twitter.com/'+loggedInArtist.twitterLink}>
                                        <img src={twitterIcon} alt='Twitter' />
                                    </a>
                                    <div className="copy-div">
                                        <div className='copy' title='Copy to clipboard'>
