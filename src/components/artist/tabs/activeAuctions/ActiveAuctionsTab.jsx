...
const ActiveAuctionsTab = () => {
    ...
    const artistActiveAuctions = PLACEHOLDER_ACTIVE_AUCTIONS.filter(auction => auction.artist.id === location.state.id);
    ...
    ) : <div className='empty__nfts'><h3>No active auctions found</h3></div>
}
