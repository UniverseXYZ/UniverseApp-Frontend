        ...
        <div className="universe__protocol__section__container">
          <AnimatedOnScroll animationIn="fadeInUp">
            <div className="universe__protocol">
              ...
              <p className="desc">
                Universe Protocol is the all binding protocol of the creative cosmic dust that is
                all around us. The unifying force of Kek is what governs the creative cosmic dust
                and brings order through governance in the Decentralized Autonomous Organization to
                the Universe. There are two main functions of the Universe Protocol, the first being
                that of minting new galaxies and the second auctioning off of said galaxies. The
                kekDAO governs the parameters of the Universe Protocols functions.
              </p>
            </div>
          </AnimatedOnScroll>
        </div>
        ...
        <div className="about__section__container">
          <div className="blocks">
            ...
            <AnimatedOnScroll animationIn="fadeInUp">
              ...
              />
              <p className="desc">
                We are developing a trustless and decentralized auction house for NFTs where anyone
                holding an NFT can put the Galaxy and/or the collection of Planets up for auction.
                These auctions can also facilitate swaps of other tokens. You will be able to pay
                with specific ERC-20 and ETH. The kekDAO will take a small fee of every auction.
              </p>
              <Button
            ...
            <AnimatedOnScroll animationIn="fadeInUp">
              ...
              <p className="desc">
                ...
                lay the framework and showcase the potential for KekDAO. We will show you how to
                create a universe of your own, build with us and help the Universe of NFTs expand
                infinitely.
              </p>
