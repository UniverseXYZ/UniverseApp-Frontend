        ...
        <div className="blocks diff">
          ...
          <AnimatedOnScroll animationIn="fadeIn">
            ...
            <p className="desc">
              ...
              artists to build and release their own NFT franchise using the features of the
              Universe Protocol. The Core Collection provides an example for aspiring artists for
              how to build out your franchise using the features of the Universe Protocol.
            </p>
          </AnimatedOnScroll>
        </div>
      </div>
