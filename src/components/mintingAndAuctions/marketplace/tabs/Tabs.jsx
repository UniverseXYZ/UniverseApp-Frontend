    ...
    return (
        <div className='tabs__section'>
            <div className='tabs__section__container'>
                <div className='tabs'>
                    <button onClick={() => { setSelectedTabIndex(0); history.push('/minting-and-auctions/marketplace/active-auctions') }} className={selectedTabIndex === 0 ? 'active' : ''}>Active auctions</button>
                    <button onClick={() => { setSelectedTabIndex(1); history.push('/minting-and-auctions/marketplace/future-auctions') }} className={selectedTabIndex === 1 ? 'active' : ''}>Future auctions</button>
                </div>
