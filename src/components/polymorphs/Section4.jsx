  ...
  return (
    <AnimatedOnScroll animationIn="fadeIn" animationInDelay={200}>
      <div className="section4--right--block">
        ...
        <p>
          Mint your very own Polymorph with it&apos;s own unique genetic code. Your morph&apos;s
          trait&apos;s can be scrambled as many times as you want to achieve the perfect Polymorph!
        </p>
